# Bookbox - Sistema de Gerenciamento de Biblioteca – TCC

Você já imaginou como a falta de um sistema eficiente pode impactar o funcionamento de uma biblioteca? Erros no controle de empréstimos, dificuldades para encontrar livros e processos manuais demorados são desafios que enfrentamos na ETEC Waldyr Duron Júnior.
...
✅ *Gerenciar empréstimos e devoluções com notificações de prazos;*

*✅ Consultar rapidamente a disponibilidade de livros;*

*✅ Gerar etiquetas personalizadas, incluindo ISBN, título, autor e número do exemplar.*

Com essa solução, garantimos mais eficiência e organização na gestão da biblioteca.
...
- PHP foi escolhido para o desenvolvimento do sistema por sua flexibilidade e interface amigável.
- MySQL foi utilizado como banco de dados para armazenar com segurança todas as informações.
...
Com a implementação do sistema, conseguiremos transformar a gestão da biblioteca, trazendo alguns benefícios como:

✔ Agilidade no atendimento, reduzindo o tempo gasto com processos manuais;

✔ Redução de erros, garantindo que todas as informações estejam atualizadas;

✔ Mais segurança e controle, evitando perdas e melhorando a organização dos livros;

Nosso **Sistema de Gerenciamento de Biblioteca** não apenas resolve os problemas atuais da ETEC Waldyr Duron Júnior, mas também representa uma solução escalável e adaptável para outras instituições.