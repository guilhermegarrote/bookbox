...
class PasswordRecoveryController extends Controller
{
     ...
     *
     * @see resources/views/pages/auth/send-recovery-code.blade.php
     */
    public function showSendRecoveryCodeForm(): View
    {
        return view('pages.auth.send-recovery-code');
    }
     ...
     *
     * @see resources/views/pages/auth/recovery-code-validation.blade.php
     */
    public function showRecoveryCodeValidationForm(): View
    {
        return view('pages.auth.recovery-code-validation');
    }
     ...
     *
     * @see resources/views/pages/auth/reset-password.blade.php
     */
